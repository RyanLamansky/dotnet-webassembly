...
public class SpecTests
{
    ...
    {
        // 2x AssertFailedException: got AssertFailedException, expected StackOverflowException (call-stack exhaustion)
    ...
    {
        // 2x AssertFailedException: got AssertFailedException, expected StackOverflowException (call-stack exhaustion)
        // 2x AssertFailedException: call_indirect-via-table-of-mismatched-type edge cases produce a different value
        // 2x AssertFailedException: an out-of-range/mismatched call_indirect surfaces as IndexOutOfRangeException
        //    rather than the spec harness's expected exception type.
        var skips = new HashSet<uint>
        {
            585, 586, 659, 660, 661, 662
        };
