...
{
	/// <summary>
	/// Tests the <see cref="Int64TruncateSignedFloat64"/> instruction.
	/// </summary>
	[TestClass]
	public class Int64TruncateSignedFloat64Tests
	{
		/// <summary>
		/// Tests compilation and execution of the <see cref="Int64TruncateSignedFloat64"/> instruction.
		/// </summary>
		[TestMethod]
		public void Int64TruncateSignedFloat64_Compiled()
		{
			var exports = ConversionTestBase<double, long>.CreateInstance(
				new GetLocal(0),
				new Int64TruncateSignedFloat64(),
				new End());
