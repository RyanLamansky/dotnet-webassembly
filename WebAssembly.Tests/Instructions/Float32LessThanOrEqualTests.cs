...
{
    /// <summary>
    /// Tests the <see cref="Float32LessThanOrEqual"/> instruction.
    /// </summary>
    [TestClass]
    public class Float32LessThanOrEqualTests
    {
        /// <summary>
        /// Tests compilation and execution of the <see cref="Float32LessThanOrEqual"/> instruction.
        /// </summary>
        [TestMethod]
