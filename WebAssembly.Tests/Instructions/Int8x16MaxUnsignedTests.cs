...
/// <summary>Tests the <see cref="Int8x16MaxUnsigned"/> instruction.</summary>
[TestClass]
public class Int8x16MaxUnsignedTests
{
    /// <summary>Export for Int8x16MaxUnsigned test.</summary>
    ...
    private static Module BuildModule()
    {
        ...
        module.Exports.Add(new WebAssembly.Export { Name = nameof(Int8x16MaxUnsignedExport.GetByte) });
    ...
    /// <summary>Verifies Int8x16MaxUnsigned produces correct results.</summary>
    [TestMethod]
    public void Int8x16MaxUnsigned_IsCorrect()
    {
        var compiled = BuildModule().ToInstance<Int8x16MaxUnsignedExport>();
