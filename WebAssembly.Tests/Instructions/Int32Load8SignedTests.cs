...
{
    /// <summary>
    /// Tests the <see cref="Int32Load8Signed"/> instruction.
    /// </summary>
    [TestClass]
    public class Int32Load8SignedTests
    {
        /// <summary>
        /// Tests compilation and execution of the <see cref="Int32Load8Signed"/> instruction.
        /// </summary>
        [TestMethod]
        ...
        /// </summary>
        [TestMethod]
        public void Int32Load8Signed_Compiled_Offset1()
        {
            var compiled = MemoryReadTestBase<int>.CreateInstance(
                new LocalGet(),
                new Int32Load8Signed
