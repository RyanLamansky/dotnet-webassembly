...
public class MemoryInitTests
{
    ...
    {
        /// <summary>Copies len bytes from the segment at srcOffset to memory at dst; returns the byte at readOffset.</summary>
    ...
    private static Module BuildModule()
    {
        ...
        module.Codes.Add(new FunctionBody
        {
            ...
            [
                ...
                new LocalGet(2), // len
                new MemoryInit { SegmentIndex = 0, MemoryIndex = 0 },
                new LocalGet(3),
    ...
    /// <summary>
    /// Tests that <see cref="MemoryInit"/> copies bytes from a passive segment into memory.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tests that <see cref="MemoryInit"/> with a source offset copies the correct sub-range.
    /// </summary>
    [TestMethod]
