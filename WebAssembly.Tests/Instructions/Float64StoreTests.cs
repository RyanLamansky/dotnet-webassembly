...
public class Float64StoreTests
{
    ...
    public void Float64Store_Compiled_Offset0()
    {
        ...
        using (compiled)
        {
            ...
            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 7, 0));
            Assert.AreEqual(Memory.PageSize - 7, x.Offset);
            Assert.AreEqual(8u, x.Length);

            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 6, 0));
            Assert.AreEqual(Memory.PageSize - 6, x.Offset);
            Assert.AreEqual(8u, x.Length);

            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 5, 0));
            Assert.AreEqual(Memory.PageSize - 5, x.Offset);
            Assert.AreEqual(8u, x.Length);

            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 4, 0));
            Assert.AreEqual(Memory.PageSize - 4, x.Offset);
            Assert.AreEqual(8u, x.Length);

            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 3, 0));
            Assert.AreEqual(Memory.PageSize - 3, x.Offset);
            Assert.AreEqual(8u, x.Length);

            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 2, 0));
    ...
    public void Float64Store_Compiled_Offset1()
    {
        ...
        using (compiled)
        {
            ...
            x = Assert.ThrowsExactly<MemoryAccessOutOfRangeException>(() => exports.Test((int)Memory.PageSize - 8, 0));
            Assert.AreEqual(Memory.PageSize - 7, x.Offset);
            Assert.AreEqual(8u, x.Length);
