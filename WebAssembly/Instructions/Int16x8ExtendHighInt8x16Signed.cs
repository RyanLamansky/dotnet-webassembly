...
public class Int16x8ExtendHighInt8x16Signed : SimdUnaryV128Instruction, IEquatable<Int16x8ExtendHighInt8x16Signed>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Int16x8ExtendHighInt8x16Signed;
    /// <inheritdoc/>
    public bool Equals(Int16x8ExtendHighInt8x16Signed? other) => other != null;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => other is Int16x8ExtendHighInt8x16Signed;
    /// <inheritdoc/>
    public override int GetHashCode() => (int)SimdOpCode.Int16x8ExtendHighInt8x16Signed;
}
