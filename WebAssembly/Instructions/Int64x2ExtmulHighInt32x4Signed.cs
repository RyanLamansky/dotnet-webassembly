...
public class Int64x2ExtmulHighInt32x4Signed : SimdBinaryV128Instruction, IEquatable<Int64x2ExtmulHighInt32x4Signed>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Int64x2ExtmulHighInt32x4Signed;
    /// <inheritdoc/>
    public bool Equals(Int64x2ExtmulHighInt32x4Signed? other) => other != null;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => other is Int64x2ExtmulHighInt32x4Signed;
    /// <inheritdoc/>
    public override int GetHashCode() => (int)SimdOpCode.Int64x2ExtmulHighInt32x4Signed;
}
