...
public class Float32x4Pmax : SimdBinaryV128Instruction, IEquatable<Float32x4Pmax>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Float32x4Pmax;
    /// <inheritdoc/>
    public bool Equals(Float32x4Pmax? other) => other != null;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => other is Float32x4Pmax;
    /// <inheritdoc/>
    public override int GetHashCode() => (int)SimdOpCode.Float32x4Pmax;
}
