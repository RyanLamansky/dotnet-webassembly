...
public class V128Load8Lane : SimdInstruction, IEquatable<V128Load8Lane>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => this.Equals(obj as V128Load8Lane);
    /// <inheritdoc/>
    public bool Equals(V128Load8Lane? other) => other != null && other.Flags == Flags && other.Offset == Offset && other.LaneIndex == LaneIndex;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => this.Equals(other as V128Load8Lane);
    /// <inheritdoc/>
