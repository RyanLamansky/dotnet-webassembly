...
public class Int32x4Sub : SimdBinaryV128Instruction, IEquatable<Int32x4Sub>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Int32x4Sub;
    /// <inheritdoc/>
    public bool Equals(Int32x4Sub? other) => other != null;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => other is Int32x4Sub;
    /// <inheritdoc/>
    public override int GetHashCode() => (int)SimdOpCode.Int32x4Sub;
}
