...
public class Int8x16ShiftRightUnsigned : SimdShiftInstruction, IEquatable<Int8x16ShiftRightUnsigned>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is Int8x16ShiftRightUnsigned;
    /// <inheritdoc/>
    public bool Equals(Int8x16ShiftRightUnsigned? other) => other != null;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => other is Int8x16ShiftRightUnsigned;
    /// <inheritdoc/>
    public override int GetHashCode() => (int)SimdOpCode.Int8x16ShiftRightUnsigned;
}
