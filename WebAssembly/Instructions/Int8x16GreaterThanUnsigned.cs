...
public class Int8x16GreaterThanUnsigned : SimdBinaryV128Instruction
{
    ...
    public static Vector128<byte> Execute(Vector128<byte> a, Vector128<byte> b) => Vector128.GreaterThan(a, b);
}
