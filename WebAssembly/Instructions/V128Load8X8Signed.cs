...
public class V128Load8X8Signed : SimdInstruction, IEquatable<V128Load8X8Signed>
{
    ...
    internal override void Compile(CompilationContext context)
    {
        ...
        context.Emit(OpCodes.Call, V128Helper.V128Load8x8SMethod.Reference);

        context.Stack.Push(WebAssemblyValueType.V128);
    }

    /// <inheritdoc/>
    public override bool Equals(object? obj) => this.Equals(obj as V128Load8X8Signed);
    /// <inheritdoc/>
    public bool Equals(V128Load8X8Signed? other) => other != null && other.Flags == this.Flags && other.Offset == this.Offset;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => this.Equals(other as V128Load8X8Signed);
    /// <inheritdoc/>
