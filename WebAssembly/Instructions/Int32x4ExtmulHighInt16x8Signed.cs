...
public class Int32x4ExtmulHighInt16x8Signed : SimdBinaryV128Instruction
{
    ...
    public static Vector128<byte> Execute(Vector128<byte> a, Vector128<byte> b) { var r = new int[4]; for (var i = 0; i < 4; i++) r[i] = a.AsInt16().GetElement(4+i) * b.AsInt16().GetElement(4+i); return Vector128.Create(r).AsByte(); }
}
