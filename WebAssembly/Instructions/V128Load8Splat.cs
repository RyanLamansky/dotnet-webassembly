...
public class V128Load8Splat : SimdInstruction, IEquatable<V128Load8Splat>
{
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => this.Equals(obj as V128Load8Splat);
    /// <inheritdoc/>
    public bool Equals(V128Load8Splat? other) => other != null && other.Flags == this.Flags && other.Offset == this.Offset;
    /// <inheritdoc/>
    public override bool Equals(Instruction? other) => this.Equals(other as V128Load8Splat);
    /// <inheritdoc/>
